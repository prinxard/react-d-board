        ...
        <Widget description={<h5>step by step guide to onboard</h5>} >
            <div className="text-base ">
                ...
                <div className="mt-5">
                    ...
                    <p className="mt-5"><strong>Note:</strong> To register for a Tax Identification Number, user can visit the State IRS website (self-service)  or click on Get <br /> KGTIN of the registration menu on the signup page on the portal [INDIVIDUAL] or [BUSINESS] as it applies to you.</p>
                    <p className="mt-4">After clicking on submit, a window like this will appear and you will have to fill in all the necessary details; <br /> create a password and enter the token sent to your phone/email). Once done click the “submit” button.</p>
                </div>
                <div className="my-8">
                    <Signinguppage />
